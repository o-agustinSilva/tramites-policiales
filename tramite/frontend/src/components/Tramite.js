        ...
        <div>
            ...
            <Container>
                ...
                <Row className="listOfTramites mt-3">
                    ...
                    <Col xs={6} className="d-flex justify-content-center align-items-center">
                        <h1 id="tramiteTitle">Certificado de Residencia</h1>   
                    </Col>
                ...
                <Row className="listOfTramites mt-3">
                    ...
                    <Col xs={6} className="d-flex justify-content-center align-items-center">
                        <h1 id="tramiteTitle">Certificado de Buena Conduta</h1>   
                    </Col>
                ...
                <Row className="listOfTramites mt-3">
                    ...
                    <Col xs={6} className="d-flex justify-content-center align-items-center">
                        <h1 id="tramiteTitle">Certificado de Declaracion Jurada</h1>   
                    </Col>
                ...
                <Row className="listOfTramites mt-3">
                    ...
                    <Col xs={6} className="d-flex justify-content-center align-items-center">
                        <h1 id="tramiteTitle">Certificado de Extravio</h1>   
                    </Col>
                ...
                <Row className="listOfTramites mt-3">
                    ...
                    <Col xs={6} className="d-flex justify-content-center align-items-center">
                        <h1 id="tramiteTitle">Certificado de Exposicion</h1>   
                    </Col>
                ...
                <Row className="listOfTramites mt-3">
                    ...
                    <Col xs={6} className="d-flex justify-content-center align-items-center">
                        <h1 id="tramiteTitle">Certificado de Declaracioon Jurada</h1>   
                    </Col>
